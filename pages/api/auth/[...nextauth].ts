        ...
        providers: [
            EmailProvider({
                server: {
                    ...
                    port: process.env.EMAIL_SERVER_SPORT,
                    auth: {
      ...
      */
        ...
        events: {
            ...
            signIn: async ({ user, account, isNewUser, profile }) => {
                console.log('[SIGN IN EVENT]', "USER", user, "ACCOUNT", account, "IS NEW USER", isNewUser, "PROFILE", profile);
            },
            ...
            updateUser: async ({ user,  }) => {
                console.log('[UPDATE USER EVENT]', "User", user);
            },
        },
